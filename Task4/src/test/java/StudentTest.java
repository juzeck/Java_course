...
public class StudentTest {
    ...
    public static void createNewStudent() {
        ...
        st1 = new Student("Bennett", "Harris", "Zakharovich", 20, "ABC-123", m1);
        st2 = new Student("Skoba", "Malomir", "Maksimovich", 25, "gfd123", m2);
        st3 = new Student("Sirchenko", "Tsvitan", "Arsenovich", 208, "MK-532", m3);
    }
